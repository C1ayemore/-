...
if (vibor == 1)
{
    ...
    Thread.Sleep(25);
    Console.Beep(397, 1000);
    Thread.Sleep(50);
    Console.Beep(366, 125);
    Thread.Sleep(250);
    Console.Beep(366, 125);
    Thread.Sleep(25);
    Console.Beep(540, 500);
    Thread.Sleep(25);
    Console.Beep(552, 500);
    Thread.Sleep(25);
    Console.Beep(296, 500);
    Thread.Sleep(25);
    Console.Beep(252, 1000);
}
if (vibor == 2)
    Console.WriteLine("завади");
{
    int[] oct = Octave(1);
    while (true)
    {
